...
Story 4.3 da IN001-cli deve estar implementada primeiro — ela cria a pasta `knowledge/`, o formato K{id} e o KNOWLEDGE-MAP.md como índice.
...
- [Dependency: IN001 Story 4.3] — cria knowledge/ e formato K{id}
