...
5. If the user provided an argument with the command, treat it as the quest TITLE — proceed directly to Passo 2 (dificuldade), then ask the anchor question (Passo 1) AFTER dificuldade and BEFORE Passo 3 (3 perguntas)
